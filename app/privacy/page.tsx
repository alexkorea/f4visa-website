...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description: "행정사사무소 이룸의 개인정보처리방침입니다.",
  alternates: {
    canonical: "https://www.f4visa.net/privacy",
  },
}
        ...
        <div className="mx-auto max-w-3xl px-4 lg:px-8">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <p className="text-muted-foreground mb-8">
              행정사사무소 이룸(이하 &quot;사무소&quot;)는 개인정보보호법에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보처리방침을 수립·공개합니다.
            </p>

            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">1. 개인정보의 처리 목적</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">3. 개인정보의 보유 및 이용기간</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">4. 개인정보의 제3자 제공</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">5. 개인정보의 파기</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">6. 정보주체의 권리</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground mt-6 mb-4">7. 개인정보 보호책임자</h2>
