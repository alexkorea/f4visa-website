  ...
  return (
    <footer className="border-t border-[#333] bg-[#1a1a1a]">
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f36c24]">
                <span className="text-lg font-bold text-white">V</span>
              </div>
              <div className="flex flex-col leading-tight">
                <span className="font-serif text-lg font-semibold text-white">VISION</span>
                <span className="text-[10px] text-gray-400 -mt-1">행정사사무소</span>
              </div>
            </Link>
            ...
            <div className="mt-6 space-y-3 text-sm text-gray-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:010-2081-3408" className="hover:text-white">
                  010-2081-3408
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 shrink-0" />
                <a href="mailto:5000meter@gmail.com" className="hover:text-white">
                  5000meter@gmail.com
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-8 lg:col-span-3">
            ...
            <div>
              <h3 className="mb-4 text-sm font-semibold text-white">자료실</h3>
              <ul className="space-y-3">
        ...
        {/* Bottom bar */}
        <div className="mt-4 flex flex-col items-center justify-between gap-4 border-t border-[#333] pt-6 sm:flex-row">
