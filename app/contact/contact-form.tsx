...
const services = [
  { value: "국적이탈", label: "국적이탈", sub: "Nationality Renunciation", icon: "🗂️" },
  { value: "국적상실", label: "국적상실", sub: "Nationality Loss", icon: "📄" },
  { value: "F-4 비자 ( 거소증 )", label: "F-4 비자 ( 거소증 )", sub: "F-4 Visa & Residence Card", icon: "📋" },
  { value: "영주권", label: "영주권", sub: "Permanent Residency", icon: "🏅" },
  { value: "국적회복", label: "국적회복", sub: "Nationality Recovery", icon: "🔄" },
  { value: "F-3 동반비자", label: "F-3 동반비자", sub: "F-3 Dependent Visa", icon: "👨‍👩‍👧" },
    ...
    return (
      <div className="rounded-xl border border-border bg-card p-10 shadow-sm text-center">
        ...
        <div className="bg-orange-50 border border-orange-100 rounded-xl p-6 mb-6 text-left">
          <h3 className="font-bold text-orange-900 text-lg mb-3">비전행정사 F-4 서비스 소개</h3>
          <ul className="space-y-2 text-sm text-orange-800">
            <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> 가장 신속히 허가되는 출입국사무소를 찾아서 진행</li>
            <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> 한국내 최소체류기간으로 처리</li>
            <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> 거소증 신청대행, 수령대행, 본국발급</li>
            <li className="flex items-start gap-2"><span className="text-orange-500 mt-0.5">✓</span> 서류 발급대행, 숙박 연락</li>
          </ul>
        </div>
