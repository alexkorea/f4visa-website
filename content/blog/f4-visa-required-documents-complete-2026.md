...
image: "/blog/f4-visa-required-documents-complete-2026.jpg"
...
행정사사무소 이룸가 F-4 비자 신청을 전문으로 처리해온 실무 매뉴얼 기준으로, 자격·서류·거소증 발급 전 과정을 정리합니다.
...
F-4 비자는 **혈통 입증 서류·국적 변경 이력·아포스티유**가 결합된 복합 행정으로, 출생지·연령·이주 시점에 따라 케이스가 수십 가지로 나뉩니다. 행정사사무소 이룸는 중국동포·CIS동포·미국·캐나다·호주 등 다양한 출신 재외동포의 F-4 비자를 전문으로 처리하며, 거소증 발급까지 원스톱 지원합니다.
...
> 이 가이드는 2026년 5월 기준 법령과 행정사사무소 이룸 실무 경험에 따라 작성되었습니다. 법령 개정 사항은 [법제처 국가법령정보센터](https://www.law.go.kr)에서 확인하실 수 있습니다.
