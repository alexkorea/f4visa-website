              ...
              <div>
                ...
                <article
                  ...
                  className="prose prose-gray max-w-none
                    ...
                    prose-th:bg-orange-50 prose-th:px-3 prose-th:py-2.5 prose-th:text-left prose-th:text-orange-900 prose-th:font-semibold prose-th:text-sm
                    ...
                    [&>nav]:bg-orange-50 [&>nav]:rounded-xl [&>nav]:p-5 [&>nav]:mb-8 [&>nav]:border [&>nav]:border-orange-200
                    [&>nav_a]:text-[#f36c24] [&>nav_a]:font-medium [&>nav_a]:no-underline
