...
const JSON_LD = {
  ...
  areaServed: "KR",
  serviceType: ["F-4 재외동포 비자", "거소증 발급", "국적상실", "국적회복", "F-5 영주권", "이중국적 신청", "국적이탈 신고"],
}
...
export const metadata: Metadata = {
  ...
  description: 'F-4 비자·거소증 필요서류·이중국적·국적이탈·국적회복 전문. 재미동포·재외동포 F-4 비자 건강보험, 거소증 발급, F-5 영주권까지 행정사가 정확히 안내. 무료상담 02-363-2251.',
  keywords: ['F-4 비자', '거소증', '국적상실', '국적회복', '영주권', '재외동포', '해외동포', '한국 비자', '이중국적', '국적이탈', '거소증 필요서류', 'F-4 비자 필요서류', 'F-4 비자 건강보험', '재미동포 거소증'],
