...
const serviceFields: Record<string, FieldDef[]> = {
  ...
  "영주권": [
    ...
    {
      name: "income",
      label: "Q7. 본인 또는 가족의 한국 내 소득 수준",
      type: "radio",
      options: ["직전년도 1인당 GNI 이상", "GNI 미만", "모름"],
      required: true,
      hint: "본인 소득이 GNI의 50% 이상이어야 가족 소득 합산이 가능합니다. 2025년 기준 1인당 GNI 약 3,500만 원",
    },
    {
      name: "topik",
      label: "Q8. 한국어능력시험(TOPIK) 또는 사회통합프로그램",
      type: "select",
    ...
    },
    {
      ...
      label: "Q10. 아포스티유 국외 범죄경력조회서가 있습니까?",
      type: "radio",
    ...
    {
      name: "delegation",
      label: "Q11. 당사에 영주권(F-5) 신청 대행을 맡기실 예정인가요?",
      type: "radio",
      options: ["예", "아니오 (직접 준비)"],
      required: true,
    },
